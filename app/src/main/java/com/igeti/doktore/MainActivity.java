...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dc = (EditText) findViewById(R.id.dcID);
        pat = (EditText) findViewById(R.id.patID);
    ...
    public void addAppointment(View view){
        ...
        try {
            ...
            jsonBody.put("appointmentDate", date.getText());
            jsonBody.put("doctorID", dc.getText());
            jsonBody.put("patientID", pat.getText());
